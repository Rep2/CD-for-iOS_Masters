...
Kontinuirana isporuka \eng{continuous deployment} je praksa u programskom inženjerstvu koja nastoji eliminirati vrijeme između razvoja i objave funkcionalnosti u produkciju. Kontinuirana dostava automatizira proces isporuke, međutim, ne isporučuje programsku potporu automatski. Svaku isporuku nove verziju programske potpore je potrebno ručuno pokrenuti. S druge strane, kontinuirana isporuka automatski isporučuju svaku novu verziju. Razlika između kontinuirane dostave i kontinuirane isporuke je prikazana na slici \ref{fig:CDDifferences}.

Automatska isporuka zahtijeva automatizaciju isporuke, a automazacija isporuke zahtijeva automatizaciju izgradnje i testiranja. Samim time kontinuirana isporuka zahtijeva kontinuiranu dostavu i integraciju. Zbog navedenog se kontinuirana isporuka smatra dodatkom kontinuirane dostave i integracije.
