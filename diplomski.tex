...
\chapter{Tehnički detalji implementacije kontinuirane isporuke}

Ovaj dodatak je tehnički usmjeren pregled implementacije kontinuirane isporuke za programsku potporu za iOS operacijski sustav. Dodatak daje pregled kreiranja i korištenja kontinuirane integracije, dostave i isporuke.

Dodatak je podjeljen prema sukladno podjeli glavnog dijela rada. Prvo je obrađena kontinuirana integracija, zatim kontinuirana dostava i na kraju dodatka kontinuirana isporuka. Svaki od poglavlja započinje pregledom alata korištenjih u poglavlju nakon čega sljede faze procesa koji se obrađuje.

Primjeri su napisani za macOS operacijski sutav te su testirani na \textit{Sierra 10.12.4} verziji. Minimalna preporučena verzija operacijskog sustava je \textit{Yosemite 10.10}.
